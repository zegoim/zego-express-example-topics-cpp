...
namespace ZEGO {
    namespace EXPRESS {
        ...
        public:
             ...
             * @param appID ZEGO 为开发者签发的应用 ID，请从 [ZEGO 管理控制台](https://console-express.zego.im/) 申请
             * @param appSign 每个 AppID 对应的应用签名，请从 ZEGO 管理控制台申请。为 64 字符的字符串。
